...
export default function AddCookiePage() {
  ...
  const {
    ...
    mode: 'onBlur' // Validate on blur for better UX, like in AddressForm
  });
  ...
  const onSubmit: SubmitHandler<CookieFormInput> = async (data) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(errorData.error || "Failed to add cookie");
      }
      ...
      // After successful add, wait a moment then redirect to dashboard
      setTimeout(() => {
      ...
      <header className="bg-white shadow-sm border-b border-gray-200 mb-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="flex items-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Add New Cookie</h1>
          </div>
          <button 
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <div className="bg-white rounded-lg shadow-md border border-gray-200">
          <div className="px-6 py-5 border-b border-gray-200">
            <h2 className="text-lg font-bold text-gray-800">Cookie Information</h2>
            <p className="mt-1 text-sm text-gray-500">
              Fill out the form below to add a new cookie to your store.
            </p>
          </div>
